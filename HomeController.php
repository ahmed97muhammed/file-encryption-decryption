...
class HomeController extends Controller
{
  ...
  */
  ...
  //forget old values of encrypted_file_content and decrypted_file_content from sessions
  ...
  //Return file details to print them into home page
  ...
  //End Function to get details of the file

  //Start Function to get humanFileSize
  ...
  //Start Function to encrypt  file
  ...
  //End Function to encrypt a file


  //Start Function to decrypt a file
  ...
  //End Function to decrypt  file


  //Start Function to download encrypted , decrypted files
 ...
 //End Function to download encrypted , decrypted files
